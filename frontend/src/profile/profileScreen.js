...
export default function ProfileScreen() {
    ...
    const [userData, setUserData] = useFetchState(
        {
            id: 1,
            username: 'Jugador1'
        },
    ...
    const [playerData, setPlayerData] =useFetchState(
        {
            id: 1,
            nickname: 'Player',
        ...
        `/api/v1/players/user/${userData.username}`,
        jwt,
        setMessage,
        setVisible,
        null
                ...
                <div className="bg">
                    ...
                    <div className="mainStatContainer">
                        <div className="statItem">
                            ...
                            <span className="statValue">{new Date(playerData.createdAt).toLocaleDateString()}</span>
                        </div>
                        <div className="statItem">
